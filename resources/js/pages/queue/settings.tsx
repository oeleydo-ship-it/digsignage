...
} from '@/components/queue/customer-notification-settings';
import {
    PreviewAnnouncementButton,
    VoiceSelect,
} from '@/components/queue/voice-controls';
...
const TABS = [
    ...
    { value: 'starvation', label: 'Starvation protection' },
    { value: 'alerts', label: 'Operational alerts' },
    { value: 'voice', label: 'Voice announcements' },
...
function initialTab(): Tab {
    ...
    return TABS.find((option) => option.value === hash)?.value ?? 'priorities';
}
    ...
    return (
        <>
            ...
            >
                <div
                    role="tablist"
                    aria-label="Queue configuration"
                ...
                >
                    {TABS.map((option) => (
                        <button
                            ...
                            aria-controls={`queue-panel-${option.value}`}
                            data-test={`queue-tab-${option.value}`}
                ...
                {tab === 'starvation' && (
                    <section
                        role="tabpanel"
                        id="queue-panel-starvation"
                        aria-labelledby="queue-tab-starvation"
                    ...
                    >
                        <div>
                            ...
                            <p className="text-muted-foreground mt-1 text-sm">
                                On Priority services, a lower-weight ticket that
                                has waited this long is served before newer
                                higher-weight tickets. Leave blank to disable.
                                Individual services choose FIFO or Priority on
                                the Services page.
                            </p>
                        </div>
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <InputError
                                    message={
                                        starvationErrors.promote_after_seconds
                                    }
                                />
                            </div>
                        </div>
                ...
                {tab === 'alerts' && (
                    <section
                        role="tabpanel"
                        id="queue-panel-alerts"
                        aria-labelledby="queue-tab-alerts"
                        className="dashboard-card space-y-4 p-5"
                    >
                        <div>
                            <h2 className="text-base font-semibold">
                            ...
                            <p className="text-muted-foreground mt-1 text-sm">
                                Notify queue administrators when service levels
                                or counter availability need attention. Delivery
                                channels are controlled in Notifications
                                settings.
                            </p>
                        </div>
                ...
                {tab === 'voice' && (
                    <section
                        role="tabpanel"
                        id="queue-panel-voice"
                        aria-labelledby="queue-tab-voice"
                        className="dashboard-card space-y-4 p-5"
                    >
                        <div>
                            <h2 className="text-base font-semibold">
                            ...
                            <p className="text-muted-foreground mt-1 text-sm">
                                When on, every display showing a queue widget
                                speaks called tickets for its services and
                                counters. To silence one widget, set its Voice
                                announcements to Off in the screen design.
                                Displays must have sound enabled once (tap
                                Enable sound on the screen).
                            </p>
                        </div>
                        <label className="flex items-center gap-2 text-sm">
                            <Checkbox
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <VoiceSelect
                                    ...
                                    languages={voiceForm.languages}
                                    onChange={(voice) =>
                                        setVoiceForm({ ...voiceForm, voice })
                                    }
                                />
                                <p className="text-muted-foreground text-xs">
                                    Voices come from this browser. Displays use
                                    the same voice when installed there, and
                                    otherwise the best match for each language.
                                </p>
                            ...
                            <div className="grid gap-2">
                                ...
                                />
                                <InputError
                                    message={voiceErrors.repeat_count}
                                />
                            </div>
                            <div className="grid gap-2">
                                ...
                                <InputError
                                    message={
                                        voiceErrors.announcement_delay_seconds
                                    }
                                />
                            </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <PreviewAnnouncementButton settings={voiceForm} />
                        </div>
                    </section>
                )}
                ...
                {tab === 'notifications' && (
                    <div
                        role="tabpanel"
                        id="queue-panel-notifications"
                        aria-labelledby="queue-tab-notifications"
                        className="space-y-4"
                    >
                        <NotificationChannels
                            slug={slug}
                        ...
                        <section className="dashboard-card space-y-4 p-5">
                            <div>
                                ...
                                <p className="text-muted-foreground mt-1 text-sm">
                                    Tick the channels for each event. Customers
                                    only get messages on channels they gave
                                    details for (email, phone, or "Notify me" on
                                    their ticket).
                                </p>
                            </div>
                            <div className="overflow-x-auto">
                                <table className="w-full min-w-[620px] text-sm">
                                                        ...
                                                        <span className="flex flex-col items-start gap-1">
                                                            ...
                                                            <ChannelStatus
                                                                provider={
                                                                    customerNotifications
                                                                        .providers[
                                                                        channel.value as keyof typeof customerNotifications.providers
                                                                    ]
                                                                }
                                                            />
                                                        </span>
                                    ...
                                    <tbody>
                                        {customerNotifications.events.map(
                                            (event) => (
                                                <tr
                                                    key={event.value}
                                                    className="border-b"
                        ...
                        <NotificationDeliveryLog
                            slug={slug}
                            deliveries={customerNotifications.deliveries}
                            canManage={permissions.canManageSettings}
                        />
                    </div>
                )}
                ...
                {tab === 'priorities' && (
                    <section
                        role="tabpanel"
                        id="queue-panel-priorities"
                        aria-labelledby="queue-tab-priorities"
                        className="space-y-4"
                    >
                        <div className="flex flex-wrap items-end justify-between gap-4">
                            <p className="text-muted-foreground text-sm">
                                Higher weight is served first. Defaults (Normal,
                                Senior, VIP, Emergency) are seeded once and
                                fully editable.
                            </p>
                            {permissions.canManageSettings && (
                                <Button
...
QueueSettings.layout = queueBreadcrumbs('Queue Configuration', '/settings');
